<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"D:\phpStudy\PHPTutorial\WWW\1\ecshoptp5\public/../application/index\view\login\register.html";i:1550548090;}*/ ?>
<!DOCTYPE html>
<html>
		...
		layui.use(['form','layer'],function(){
			...
			$("#sendEmailCode").click(function(){
				...
				if(sendEmail==''){
					...
					$.ajax({
						type:'post',
						url:"<?php echo url('Login/emailUnique'); ?>",
