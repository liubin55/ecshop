<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/admin\view\admin\adminupdate.html";i:1547256782;s:72:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/admin\view\layout.html";i:1547012609;s:76:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/admin\view\public\top.html";i:1547273082;s:77:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/admin\view\public\left.html";i:1546944110;}*/ ?>
<!doctype html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="layui-body">
    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item" >
            ...
            <input type="text" name="admin_name" value="<?php echo $data['admin_name']; ?>" lay-verify="required|checkName"  autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <input type="text" name="admin_tel" value="<?php echo $data['admin_tel']; ?>"  lay-verify="required|phone" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <input type="text" name="admin_email" value="<?php echo $data['admin_email']; ?>"  lay-verify="required|email" autocomplete="off" class="layui-input">
            </div>
        </div>
