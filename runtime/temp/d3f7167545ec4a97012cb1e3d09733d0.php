<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:84:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/index\view\address\addressadd.html";i:1551499301;s:72:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/index\view\layout.html";i:1550892650;s:79:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/index\view\public\header.html";i:1551411942;s:80:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/index\view\public\usertop.html";i:1551412612;s:81:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/index\view\public\userleft.html";i:1551412829;s:79:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/index\view\public\footer.html";i:1548036843;}*/ ?>
...
<div class="m_left">
    ...
    <div class="left_m">
		...
		<div class="m_right">
            ...
            <?php if(is_array($addressInfo) || $addressInfo instanceof \think\Collection || $addressInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $addressInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($v['address_default'] == 1): ?>
			<div class="address" style="border:1px solid red" address_id="<?php echo $v['address_id']; ?>">
                ...
                <p align="right">
                   <a href="<?php echo url('Address/addressUpdate'); ?>?address_id=<?php echo $v['address_id']; ?>" style="color:#ff4e00;">编辑</a>&nbsp; &nbsp; &nbsp; &nbsp; 
                </p>

            </div>
            <?php else: ?>
			<div class="address" address_id="<?php echo $v['address_id']; ?>">
            	<div class="a_close"><a href="javascript:;" class="del"><img src="__STATIC__/index/images/a_close.png" /></a></div>
                <table border="0" class="add_t" align="center" style="width:98%; margin:10px auto;" cellspacing="0" cellpadding="0">
                    <tr>
                    <td align="right" width="80">收货人姓名：</td>
                ...
                <p align="right">
                	<a href="javascript:;" style="color:#ff4e00;" class="default">设为默认</a>&nbsp; &nbsp; &nbsp; &nbsp; <a href="<?php echo url('Address/addressUpdate'); ?>?address_id=<?php echo $v['address_id']; ?>" style="color:#ff4e00;">编辑</a>&nbsp; &nbsp; &nbsp; &nbsp; 
                </p>
              ...
              <tr>
                ...
                <td colspan="3" style="font-family:'宋体';">
                	<select class="province" id="province">
                      ...
                      <?php if(is_array($areaInfo) || $areaInfo instanceof \think\Collection || $areaInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $areaInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
        ...
        $(function(){
            layui.use('layer',function(){
                ...
                $(document).on('click','.add_b',function(){
                   ...
                   $.post(
                       "<?php echo url('Address/addressDo'); ?>",
                       obj,
                       function(res){
                           layer.msg(res.font,{icon:res.code});
                       },'json'
                ...
                $(document).on('click','.del',function(){
                    ...
                    layer.confirm('你确定要删除吗',{icon:3,title:'提示'},function(index){
                        $.post(
                            "<?php echo url('Address/addressDel'); ?>",
                ...
                $(document).on('click','.default',function(){
                    ...
                    var address_id=_this.parents("div[class='address']").attr('address_id');
                    $.post(
                        "<?php echo url('Address/addressDefault'); ?>",
                        {address_id:address_id},
                        function(res){
                            if(res.code==1){
