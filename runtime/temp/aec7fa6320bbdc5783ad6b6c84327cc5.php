<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/admin\view\goods\goodsedit.html";i:1548033969;s:72:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/admin\view\layout.html";i:1547012609;s:76:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/admin\view\public\top.html";i:1547705485;s:77:"D:\phpStudy\WWW\1\ecshoptp5\public/../application/admin\view\public\left.html";i:1547546209;}*/ ?>
<!doctype html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-side layui-bg-black">
  ...
  <div class="layui-body">
    ...
    <form class="layui-form" onsubmit="return false">
        <input type="hidden" id="goods_id" name="goods_id" value="<?php echo $arr['goods_id']; ?>">
      <div class="layui-form-item">
        <label class="layui-form-label">商品名称</label>
        <div class="layui-input-block">
          <input type="text" name="goods_name" value="<?php echo $arr['goods_name']; ?>" required  lay-verify="required|checkName" placeholder="请输入商品名称" autocomplete="off" class="layui-input">
        </div>
      </div>
      <div class="layui-form-item">
        <label class="layui-form-label">本店售价</label>
        <div class="layui-input-block">
          <input type="text" name="self_price" value="<?php echo $arr['self_price']; ?>" required lay-verify="required|number" placeholder="￥" autocomplete="off" class="layui-input">
        </div>
      </div>
      <div class="layui-form-item">
            <label class="layui-form-label">市场售价</label>
            <div class="layui-input-block">
                    <input type="text" name="market_price" value="<?php echo $arr['market_price']; ?>" required lay-verify="required|number" placeholder="￥" autocomplete="off" class="layui-input">
            </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
     ...
     <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                    <input type="text" value="<?php echo $arr['goods_num']; ?>" name="goods_num" required lay-verify="required|number" placeholder="剩余库存" autocomplete="off" class="layui-input">
            </div>
     </div>
    <div class="layui-form-item">
            <label class="layui-form-label">赠送积分</label>
            <div class="layui-input-block">
                    <input type="text" value="<?php echo $arr['goods_score']; ?>" name="goods_score" required lay-verify="required|number" placeholder="积分数" autocomplete="off" class="layui-input">
            </div>
     </div>
      <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                    ...
                    <img src="/uploads/goodsLogo/<?php echo $arr['goods_img']; ?>" width="100px" height="100px" id="img">
                    <input type="hidden" value="<?php echo $arr['goods_img']; ?>" name="goods_img" id="img">
            </div>
      </div>
      <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                    ...
                    <input type="hidden" value="<?php echo $arr['goods_imgs']; ?>" name="goods_imgs" id="imgs">
            </div>
      </div>
      <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                    ...
                    <?php if(is_array($cateInfo) || $cateInfo instanceof \think\Collection || $cateInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $cateInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($arr['cate_id'] == $v['cate_id']): ?>
      ...
      <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                    <select name="brand_id" >
                            <option value="">--请选择--</option>
                    <?php if(is_array($brandInfo) || $brandInfo instanceof \think\Collection || $brandInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $brandInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($arr['brand_id'] == $v['brand_id']): ?>
                            <option value="<?php echo $v['brand_id']; ?>" selected><?php echo $v['brand_name']; ?></option>
                    <?php else: ?>
      ...
      <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="goods_desc" id="demo" style="display: none;"><?php echo $arr['goods_desc']; ?></textarea>
        </div>
      </div>
      <div class="layui-form-item">
        <div class="layui-input-block">
    ...
    form.on('submit(formDemo)', function(data){
        ...
        $.post(
        "<?php echo url('Goods/goodsEditDo'); ?>",
        data.field,
            function(res){
                if(res.code==1){
